...
import com.example.demo2.entities.relation.SchoolAndDirector
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            ...
            val schoolWithDirector:LiveData<List<SchoolAndDirector>> = schoolDao.getSchoolAndDirectorWithSchoolName("kotlin_school")
        }
    }
}